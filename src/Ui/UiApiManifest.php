 ...
 * contracts and the module entries the matcher accepted against them (the
 * platform rule: hosts implement contracts, modules offer entries).
 * Serialized as-is; core-angular's `UiApiManifest` is its mirror.
 *
