# Contributing to `coolms/core-bundle`
...
`coolms/core-bundle` is a **platform package** -- it builds on `coolms/core` and only
...
`coolms/core-bundle 2.0.0` does not assert that this package broke something; it
